...
export function filterbyratenumber(props) {
  ...
  props.navigation.setOptions({
    headerTitle: () => <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
      <Text style={styles.Title}>Les mieux notées</Text>
      <MaterialIcons style={{ marginLeft: 5 }} name="stars" size={30} color="#d3d0d2" />
    </View>,
    headerStyle: {
...
export default filterbyratenumber
